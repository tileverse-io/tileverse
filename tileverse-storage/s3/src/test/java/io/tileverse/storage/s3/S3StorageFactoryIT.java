...
/**
 * Integration tests for {@link StorageFactory} provider resolution against real, publicly accessible S3 URLs.
 *
...
class S3StorageFactoryIT {
    ...
    void testRealS3Urls(String description, String url) {
        URI s3Uri = URI.create(url);
        // Verify URL parsing routes the URI to the S3 provider. We don't actually
