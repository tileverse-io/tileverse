...
/**
 * {@link S3ClientHandle} that wraps a caller-supplied {@link S3ClientBundle}. {@link #close()} is a no-op so the caller
 * retains ownership of the SDK clients.
 */
