...
/** Translate GCS SDK StorageException into the storage exception hierarchy. */
final class SdkExceptionMapper {

    private SdkExceptionMapper() {}

    static StorageException map(com.google.cloud.storage.StorageException cause, String contextKey) {
        switch (cause.getCode()) {
            ...
            default:
                return new StorageException(messageFor(cause, contextKey, "GCS error"), cause);
        }
    }
