...
| Library | Usage | Module |
| :--- | :--- | :--- |
| **[AWS SDK for Java v2](https://github.com/aws/aws-sdk-java-v2)** | S3 Range Reader | `storage-s3` |
| **[Azure SDK for Java](https://github.com/Azure/azure-sdk-for-java)** | Azure Blob Range Reader | `storage-azure` |
| **[Google Cloud Java](https://github.com/googleapis/google-cloud-java)** | GCS Range Reader | `storage-gcs` |
