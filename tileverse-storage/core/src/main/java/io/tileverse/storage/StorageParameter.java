 ...
 * including its key, description, type, default value, and a list of sample values.
 *
 ...
 */
public record StorageParameter<T>(
        String key,
        String title,
        String description,
        String group,
    ...
    /**
     * Compact constructor for {@link StorageParameter} that performs validation.
     *
    ...
    /**
     * Creates a new {@link Builder} for constructing a {@link StorageParameter}.
     *
    ...
    public static class Builder {
        ...
        /**
         * Builds a new {@link StorageParameter} instance.
         *
         * @param <T> The type of the parameter value.
         * @return A new {@link StorageParameter}.
         * @throws NullPointerException if key, description, group, or type is {@code null}.
         */
        @SuppressWarnings("unchecked")
        public <T> StorageParameter<T> build() {
            return new StorageParameter<>(
                    key,
                    title,
                    description,
                    group,
